...
<DemoGif
  ...
  caption="flame → amber arc at `speed = 2` — border pulses only within the phoenix-warm band, never drifting into green or blue"
/>

<TomlExample
  code={`# Flame → amber arc — stays within the §6 brand palette
...
<TomlExample
  code={`border = {style = "color_cycle", from = [255, 92, 38], to = [255, 183, 3], speed = 2, thickness = 2}
