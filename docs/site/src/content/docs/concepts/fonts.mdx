...
BDF fonts (the smallsign default) keep their bitmap behavior: a character not in the BDF's bitmap is skipped (zero advance, no glyph drawn). On BDF widgets, stick to ASCII unless you've verified the codepoints you need are in the bitmap.
