...
<img
  ...
  alt="The web UI Status tab — a live browser preview of the sign, the now-playing widget, section health, and the loaded plugins, with the sign's hostname blurred."
/>
