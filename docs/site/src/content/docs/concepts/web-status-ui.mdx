...
The display process publishes a `status.json` file (schema version 4) containing the state of the running display. The web UI renders this snapshot; advanced users and integrations can also read it directly. Key fields:
