...
[Hacker News](https://news.ycombinator.com/) headlines via the `rss.feed`
widget and a Nyan Cat sprite-trail transition via `nyancat.forward` — no API
keys or `.env` file needed. To swap in different plugins, edit
