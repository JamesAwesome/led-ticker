...
led-ticker ships two **reference builds**: the
[smallsign](/hardware/smallsign/) (Pi 4 + 5× 32×16 panels) and the
[bigsign](/hardware/bigsign/) (Pi 5 + 8× P3 32×64 panels). They're
starting points, not requirements — anything in between (or beyond)
is a viable build, and the engine is the same.
