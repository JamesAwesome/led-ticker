...
# --- RSS Feeds (led-ticker-feeds plugin) ---
# RSS/Atom headlines (type = "feeds.rss") via the led-ticker-feeds plugin.
# See https://github.com/JamesAwesome/led-ticker-feeds for install + config.

# --- Crypto Prices (led-ticker-crypto plugin) ---
# Live CoinGecko prices via the led-ticker-crypto plugin.
# See https://github.com/JamesAwesome/led-ticker-crypto for install + config.

# --- MLB Scores (led-ticker-baseball plugin) ---
# Requires the led-ticker-baseball plugin — add
# git+https://github.com/JamesAwesome/led-ticker-baseball.git@main to
# config/requirements-plugins.txt and rebuild. Free MLB Stats API, no key
...
# --- MLB Standings (led-ticker-baseball plugin) ---
# Same plugin as above. Top-N teams by record plus any teams you're tracking.
# Shows "Opens [date]" during offseason / spring training. The plugin also
...
# --- Weather (led-ticker-feeds plugin) ---
# Current conditions + temperature (type = "feeds.weather") via the
# led-ticker-feeds plugin. Needs a free WEATHERAPI_KEY in .env.
# See https://github.com/JamesAwesome/led-ticker-feeds for install + config.
```
