...
# (https://docs.ledticker.dev/plugins/): add it to config/requirements-plugins.txt
# (copy requirements-plugins.example.txt, or use the web UI Store tab), restart,
# then add a section using its widget type:
#
