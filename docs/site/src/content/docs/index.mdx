...
<CardGrid>
  ...
  <Card title="MLB baseball (plugin)">
    <DemoGif src="/demos-pinned/baseball-statcast.gif" caption="A 452 ft home run drawing its own trajectory arc over the wall — the baseball plugin's Statcast hero card." />
