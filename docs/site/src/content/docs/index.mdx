...
<CardGrid>
  <Card title="Weather (plugin)">
    <DemoGif src="/demos-long/widget-weather.gif" caption="Current conditions for any location — via the led-ticker-feeds plugin." />

    [Weather widget →](/widgets/weather/)

  </Card>
  <Card title="MLB scores (plugin)">
    <DemoGif src="/demos-long/widget-mlb.gif" caption="Live game scores and counts — via the led-ticker-baseball plugin." />
