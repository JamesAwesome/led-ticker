...
| `compute_cursor(canvas_width, content_width, cursor_pos, padding, center)` | Resolve a start cursor + end padding for content of a given width (centering / overflow math) |
