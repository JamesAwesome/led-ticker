...
For the exact signatures of `is_scaled`, `unwrap_to_real`, `paint_hires`, `snap_reset`, and `SNAP_THRESHOLD`, see the [API reference](/plugins/api-reference/). The [`baseball`](https://github.com/JamesAwesome/led-ticker-plugins/tree/main/plugins/baseball) package is a real, shipped example of this pattern.
