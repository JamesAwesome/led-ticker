...
| `hot_reload`               | bool   | `true`           | Watch `config.toml` and live-reload sections/widgets/transitions/schedule/brightness/timezone without restarting (`[display]` changes otherwise need a restart, as do `[busy_light]`, `[plugins]`, `[web]`). Set `false` to disable.  |
...
| `timezone`                 | string | `""`             | IANA timezone for ALL schedules (visibility + brightness), e.g. `"America/New_York"`; empty = system local. `display.schedule.timezone` still overrides for brightness windows.                                                       |
...
| Field                  | Type                         | Default                           | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ---------------------- | ---------------------------- | --------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `mode`                 | string                       | `"ticker"`                        | One of `ticker`, `one_at_a_time`, `slideshow`. See [Sections and modes](/concepts/sections-and-modes/).                                                                                                                                                                                                                                                                                                                                                                    |
...
| `schedule`             | table                        | none (always shown)               | Show this section only during a time window: `{ start = "09:00", end = "21:00", days = ["mon"] }`; `start > end` wraps overnight. See [Widget scheduling](/concepts/scheduling/).                                                                                                                                                                                                                                                                                          |
