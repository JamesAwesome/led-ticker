...
<img
  src="/panel-test/rgb-cycle.gif"
  alt="A bigsign panel on a wall cycling through full-frame red, green, blue, white, then black on real hardware, with the colors reflecting off the floor below."
/>
