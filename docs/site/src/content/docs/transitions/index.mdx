...
| [Sprite / flair](/transitions/sprite/) | Pixel-art character (Pac-Man, Nyan Cat, Pokéball, …) crosses the panel; text spins out (`flair.spinout`); fireworks burst (`flair.fireworks`); an emoji sticker-bomb builds and peels (`flair.stickers`); or card-suit ripples wash the panel (`flair.poker`) | Fun / themed                      |
