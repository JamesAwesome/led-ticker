...
| [Sprite / flair](/transitions/sprite/) | Pixel-art character (Pac-Man, Nyan Cat, Pokéball, …) crosses the panel; text spins out (`flair.spinout`); or fireworks burst over the outgoing widget (`flair.fireworks`) | Fun / themed                      |
