...
<DemoGif
  ...
  caption="moon on the right, held magenta `@moonbunny` on top, cream promo scrolling fully offscreen-to-offscreen on the bottom — keeps cycling within `hold_time`"
/>
