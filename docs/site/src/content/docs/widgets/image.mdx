...
<DemoGif
  ...
  caption="moon on the right, held magenta `@firebird` on top, cream promo scrolling fully offscreen-to-offscreen on the bottom — keeps cycling within `hold_time`"
/>
...
<DemoGif
  ...
  caption="moon on the right, `@firebird` on top, scrolling promo on the bottom"
/>
...
<DemoGif
  ...
  caption="moon on the left, `firebird` types in on the right with rainbow font_color"
/>
