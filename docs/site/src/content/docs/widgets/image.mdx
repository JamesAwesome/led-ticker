...
<DemoGif
  ...
  caption="still moon on the left, held magenta `BREAKING` up top, cyan `tap to subscribe` wrapping continuously on the bottom with a rainbow `*` separator"
/>
...
<DemoGif
  ...
  caption="moon on the right, held magenta `@moonbunny` on top, cream promo scrolling fully offscreen-to-offscreen on the bottom — keeps cycling within `hold_seconds`"
/>
...
<TomlExample
  code={`[[playlist.section.widget]]
type = "image"
path = "config/assets/album_art.png"
