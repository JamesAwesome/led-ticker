---
title: Widgets
description: The 8 built-in widgets — what each one does and how to pick.
---

import RelatedPages from "../../../components/RelatedPages.astro";

led-ticker ships **8 built-in widget types**. Each is configured by a
...
- **Live data (background fetch):** `weather`, `rss_feed`, plus the plugin widgets `pool`, `baseball.scores`, `baseball.standings`, and `crypto.coingecko`. Each has retry + exponential backoff.
