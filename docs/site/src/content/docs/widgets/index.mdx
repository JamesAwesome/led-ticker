---
title: Widgets
description: The 10 built-in widgets — what each one does and how to pick.
---

import RelatedPages from "../../../components/RelatedPages.astro";

led-ticker ships **10 built-in widget types**. Each is configured by a
...
- **Live data (background fetch):** `weather`, `rss_feed`, the three crypto widgets, plus the plugin widgets `pool`, `baseball.scores`, and `baseball.standings`. Each has retry + exponential backoff.
