...
Both `text =` and `message =` work for the content string. The reference examples on this site use `text =`; existing configs with `message =` are equally valid and will continue to work.
