...
def _generate_baseball_hires(
    ...
    # Upper seam: top-right → mid-left (leans \).
    seam1 = trace_seam(
    ...
    # Lower seam: mid-left → bottom-right (leans /). Together with the
    # upper seam this forms a connected S-curve wrapping the ball, which
    # matches the reference baseball where the two seams lean OPPOSITE
    # ways and meet near the mid-left edge.
    seam2 = trace_seam(
