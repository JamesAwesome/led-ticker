...
class Baseball:
    ...
    def frame_at(
        ...
        from led_ticker.widgets.baseball import draw_baseball_frame
...
class BaseballReverse:
    ...
    def frame_at(
        ...
        from led_ticker.widgets.baseball import draw_baseball_frame_rtl
...
class Pacman:
    ...
    def frame_at(
        ...
        from led_ticker.widgets.pacman import draw_pacman_frame
...
class PacmanReverse:
    ...
    def frame_at(
        ...
        from led_ticker.widgets.pacman import draw_pacman_frame_rtl
