...
class TestWrapsForeverRespected:
    @pytest.mark.asyncio
    async def test_wraps_forever_widget_runs_for_hold_time(self):
    ...
    @pytest.mark.asyncio
    async def test_finite_widget_unaffected(self):
    ...
    @pytest.mark.asyncio
    async def test_wraps_forever_widget_scrolls_pos(self):
    ...
    @pytest.mark.asyncio
    async def test_wraps_forever_widget_bounded_by_hold_time(self):
...
class TestWrapsForeverBottomTextLoops:
    @pytest.mark.asyncio
    async def test_wraps_forever_extends_n_ticks_for_bottom_text_loops(self):
    ...
    @pytest.mark.asyncio
    async def test_wraps_forever_hold_time_wins_when_longer(self):
