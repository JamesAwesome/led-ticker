...
def main() -> None:
    ...
    # The module is emitted as a double-quoted literal (ruff-format's style);
    # neither char can be a CLDR emoji codepoint, but belt it anyway.
    assert '"' not in bmp and "\\" not in bmp
    _BMP_OUT.write_text(
